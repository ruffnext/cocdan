...
export interface IDetail { status: IStatus, attrs: IAttrs, descriptor: IDescriptor, skills: Record<string, ISkillAssigned>, occupation: IOccupation, equipments: Array<IEquipment>, }