...
#[ts(
    export,
    rename = "IWeaponRange",
    export_to = "entity/weapon/IWeaponRange.d.ts"
)]
...
#[ts(
    export,
    rename = "IAmmoCapacity",
    export_to = "entity/weapon/IAmmoCapacity.d.ts"
)]
...
#[ts(
    export,
    rename = "IExtraEffect",
    export_to = "entity/weapon/IExtraEffect.d.ts"
)]
...
#[ts(
    export,
    rename = "IWeaponDamage",
    export_to = "entity/weapon/IWeaponDamage.d.ts"
)]
...
#[derive(serde::Serialize, serde::Deserialize, TS, PartialEq, Default, Debug, Clone)]
#[ts(export, rename = "IWeapon", export_to = "entity/weapon/IWeapon.d.ts")]
pub struct Weapon {
    pub name: String,
