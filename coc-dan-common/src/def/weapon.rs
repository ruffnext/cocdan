...
#[ts(
    export,
    rename = "IWeaponRange",
    export_to = "bindings/weapon/IWeaponRange.ts"
)]
...
#[ts(
    ...
    export_to = "bindings/weapon/IAmmoCapacity.ts"
)]
...
#[ts(
    export,
    rename = "IExtraEffect",
    export_to = "bindings/weapon/IExtraEffect.ts"
)]
...
#[ts(
    ...
    export_to = "bindings/weapon/IWeaponDamage.ts"
)]
