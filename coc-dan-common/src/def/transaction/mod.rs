...
#[ts(
    export,
    rename = "ITransaction",
    export_to = "bindings/tx/ITransaction.ts"
)]
...
#[ts(
    export,
    rename = "IDiceResult",
    export_to = "bindings/dice/IDiceResult.ts"
)]
pub enum DiceResult {
    DicePending,
    DiceNaive(DiceNaive),
...
#[ts(
    export,
    rename = "IDiceNaive",
    export_to = "bindings/dice/IDiceNaive.ts"
)]
pub struct DiceNaive {
    // naive dice, r1d3, r2d10, r1d100 * 2......
    pub result: u32,
}
...
#[ts(
    export,
    rename = "IDiceCheck",
    export_to = "bindings/dice/IDiceCheck.ts"
)]
pub struct DiceCheck {
    // check dice, rc str, rc pow, rc str/2
    pub result: u32,
...
#[ts(
    export,
    rename = "IDiceSanLoss",
    export_to = "bindings/dice/IDiceSanLoss.ts"
)]
...
#[ts(
    export,
    rename = "IDiceSanCheck",
    export_to = "bindings/dice/IDiceSanCheck.ts"
)]
pub struct DiceSanCheck {
    // sc 1/1d3
